...
getNoVariantsList1([H|T],[W1|E1],[H|List]):-
    ...
    R1=[H3,H4,H5,H6,H7,H8,H1,H2],
    R2=[H5,H6,H7,H8,H1,H2,H3,H4],
    R3=[H7,H8,H1,H2,H3,H4,H5,H6],
    (   \+member(R1,[W1|W1]),!,
        getNoVariantsList1(T,[W1|E1],List);
    \+member(R2,[W1|E1]),!,
        getNoVariantsList1(T,[W1|E1],List);
    \+member(R3,[W1|E1]),!,getNoVariantsList1(T,[W1|E1],List)).
...
[2, 0, 1, 2, 0, 2, 1, 0], [2, 1, 0, 1, 2, 1, 0, 1], [2, 1, 0, 2, 1, 1, 1, 0], [2, 1, 0, 2, 1, 2, 0, 1]]
*/
